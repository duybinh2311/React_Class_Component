...
/* 
  ...
  Thay vào đó PureComponent sẽ tự nhận biết props khi có thay đổi thì sẽ render lại, còn không thay đổi thì không render.
  Tuy nhiên sự so sánh props có thay đổi hay không chỉ là shallow compare (so sánh được những giá trị primitive value)
*/
